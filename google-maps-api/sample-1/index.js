...
if( ! document.getElementById('googleMapAPI') ){
	...
	s.id = 'googleMapAPI';
	s.src = 'https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false&libraries=places&key=AIzaSyD3JDoc1Xam2GP0rb4JShPqdGuwVe_Ijms&callback=controlMap';
...
function initializeMap(){
	...
	Clat || (Clat = 10.762642865479595, $("#" + mapCenLat).val(Clat));
	Clng || (Clng = 106.68273389339447, $("#" + mapCenLng).val(Clng));
